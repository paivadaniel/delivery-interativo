...
<!-- o AJAX que chama salvar.php está em js/ajax.js, e AJAX de excluir.php também -->
...
<script type="text/javascript">
	function listar() { //diferente da função listar() que está js/ajax.js, aquela é padrão, não muda para muitas listagens feitas pelos arquivos, essa é específica para datas
...
<script type="text/javascript">
	function baixar(id) { //muda o status da conta de pendente para pago
		$.ajax({
