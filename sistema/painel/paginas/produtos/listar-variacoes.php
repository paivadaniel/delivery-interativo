...
$id_produto_var = $_POST['id_prod_var'];

$query = $pdo->query("SELECT * FROM $tabela WHERE produto = '$id_produto_var' order by id desc");
...
if ($total_reg > 0) {
    ...
    echo <<<HTML
	<small>
	<table class="table table-hover" id="tabela-var"> <!-- id é para referenciar a tabela depois para o DataTable -->
	<thead> 
	<tr> 
	<th>Nome</th>	
...
HTML;
    ...
    echo '<small>Não possui variação cadastrada!</small>';
}
