					...
					<div class="row">
						...
						<div class="col-md-6">
							...
							<div class="form-group">
								...
								<select class="form-control sel2" id="cliente" name="cliente" style="width:100%;">
...
<script type="text/javascript">
	...
	function editar(id, descricao, cliente, valor, data_venc, data_pgto, foto) {
		$('#id').val(id);
	...
	function mostrar(descricao, valor, data_lanc, data_venc, data_pgto, usuario_lanc, usuario_pgto, foto, cliente, link) {
