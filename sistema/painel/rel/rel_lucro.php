...
<body>
	...
	<img class="imagem" src="<?php echo $url_sistema ?>/img/logo_rel.jpg" width="150px">
	...
	<div class="mx-2">
		...
		<table class="table table-striped borda" cellpadding="6">
			<thead>
				<tr align="center">
					<th scope="col">Vendas</th> <!-- autor mudou de th para td pois o align="center" não estava funcionando, porém, eu não fiz isso, head é head (th), data é data (td) -->
